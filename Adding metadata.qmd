...
**Mac users** - the stages of setting up a new case are similar, but the menus might look a bit different. 
...
NB. These instructions below are for Windows users. 
Mac users do have chart functions, but they are more limited. 
