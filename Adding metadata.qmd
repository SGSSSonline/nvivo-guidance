...
- **Mac users** - import csv file instead. 
...
**mac users**- this import wizard looks a bit different: 

![](images/case class mac.png)

- Set classification type as ‘case classification’.

**Mac users** - here create new case classification 'People' (Windows users have done this step earlier).
...
NB. option not available on mac- just click through. 
