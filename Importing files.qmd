...
The option to create cases automatically on import is available for Windows users only. Mac users, we will tell you how to create cases later. 
...
### Manually create cases (macOS only)

Let's now create cases manually so that we are at the same stage as windows users. This is very simple. 
...
{{< fa brands apple >}} **NVivo for macOS**: You need to use the ribbon menu at the top to import files directly into the folders. 
